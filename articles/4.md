...
<br/>
<p align="center"><img src="../images/chart1.png" width="400"><br><i><a href="https://pushdata.io">Throwing in a picture to make this article less text-heavy</a></i></p>
<br/>
...
end I felt insecure trusting InfluxDB with my (my users') data. I had the same feeling about Cassandra, but there 
I was more certain that it was mainly a case of me not knowing how to run Cassandra (and big Java apps in general).
