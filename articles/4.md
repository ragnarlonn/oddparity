...
end I felt insecure trusting InfluxDB with my (my users') data. I had the same feeling about Cassandra in another project, but there I was more certain that it was mainly a case of me not knowing how to run Cassandra (and big Java apps in general).
