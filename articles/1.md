...
Now it just took me one hour to create a new treasure hunt crossword: I would generate something with the generator, then use Google docs to do the actual design and get a printable PDF.
...
My friend took pity on me when he saw the state of things and as he also happened to have a kid about the same age, who was also just about ready to learn to read, he decided to help out with the front-end parts. Now the app is a lot more slick, you can check it out in its current state at [puzzlepirate.net](https://puzzlepirate.net)
